...
<form method="post"  action="modulos/mdl_reg_producto.php" id="frm_reg_Productos" >
  ...
  <div class="container">
   ...
   <div class= "grid-item"><div class= "container-grid"><div class= "grid-item-container"><p><label>Nomre del producto: <span class="requerido">*</span></label></p></div><div class= "grid-item-container"><p><input name="codigo" type="text" id="codigoid" required></p></div></div></div>
