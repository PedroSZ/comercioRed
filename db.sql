...
(1, 'Patria', '375 100 3330', 'lapiconeria@gmail.com', 'Av. Patria No. , Colonia Santuario, C.P. 46620. Am', 'logotipos/1756919785_Logotipo.png', '#fcf8f8', '#f7f7f7', '#69b894', '#000000', '#4e4b4b', '#2259f2', '#eddd53', '#ad8225', '#2259f2', '#000000', '#7d7d7d', '#fafafa', '#666060', '#4665e2', '#394660', '#fefbfb', '#fcfcfc');
