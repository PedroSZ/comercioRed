...
INSERT INTO Tipo_Usuario (Usuario, Pasword, Puesto, Estatus_u) VALUES
('user1', MD5('123'), 'Administrador',1),
('user2', MD5('123'), 'Cajero',1),
('user3', MD5('123'), 'Vendedor',0),
('user4', MD5('123'), 'Supervisor',0),
('user5', MD5('123'), 'Almacenista',1),
('user6', MD5('123'), 'Vendedor',1),
('user7', MD5('123'), 'Cajero',1),
('user8', MD5('123'), 'Administrador',1),
('user9', MD5('123'), 'Vendedor',1),
('user10', MD5('123'), 'Cajero',1);
...
INSERT INTO Cliente (Rfc, Nombre, A_paterno, A_Materno, Fecha_Registro, Fecha_Nacimiento, Telefono, Email, Domicilio, Limite_Credito, Credito_Usado, Estatus_c) VALUES
('000000000000011', 'Cliente1', 'ApellidoP1', 'ApellidoM1', '2025-06-14', '1990-01-01', '1111111111', 'cliente1@mail.com', 'Domicilio 1', 10000, 2000,1),
('000000000000012', 'Cliente2', 'ApellidoP2', 'ApellidoM2', '2025-06-14', '1991-02-02', '2222222222', 'cliente2@mail.com', 'Domicilio 2', 15000, 3000,1),
('000000000000013', 'Cliente3', 'ApellidoP3', 'ApellidoM3', '2025-06-14', '1992-03-03', '3333333333', 'cliente3@mail.com', 'Domicilio 3', 12000, 2500,1),
('000000000000014', 'Cliente4', 'ApellidoP4', 'ApellidoM4', '2025-06-14', '1993-04-04', '4444444444', 'cliente4@mail.com', 'Domicilio 4', 8000, 1000,1),
('000000000000015', 'Cliente5', 'ApellidoP5', 'ApellidoM5', '2025-06-14', '1994-05-05', '5555555555', 'cliente5@mail.com', 'Domicilio 5', 20000, 5000,1),
('000000000000016', 'Cliente6', 'ApellidoP6', 'ApellidoM6', '2025-06-14', '1995-06-06', '6666666666', 'cliente6@mail.com', 'Domicilio 6', 30000, 10000,1),
('000000000000017', 'Cliente7', 'ApellidoP7', 'ApellidoM7', '2025-06-14', '1996-07-07', '7777777777', 'cliente7@mail.com', 'Domicilio 7', 5000, 0,0),
('000000000000018', 'Cliente8', 'ApellidoP8', 'ApellidoM8', '2025-06-14', '1997-08-08', '8888888888', 'cliente8@mail.com', 'Domicilio 8', 18000, 7000,1),
('000000000000019', 'Cliente9', 'ApellidoP9', 'ApellidoM9', '2025-06-14', '1998-09-09', '9999999999', 'cliente9@mail.com', 'Domicilio 9', 25000, 12000,0),
('000000000000020', 'Cliente10', 'ApellidoP10', 'ApellidoM10', '2025-06-14', '1999-10-10', '1010101010', 'cliente10@mail.com', 'Domicilio 10', 10000, 5000,1);

INSERT INTO Productos (Codigo, Nombre, Descripcion, Stock, Fecha_Caducidad, Fecha_Registro, Costo, Precio, Estatus_p) VALUES
('1001', 'Producto1', 'Descripcion 1', 50, '2026-12-31', '2025-06-14', 20, 30,1),
('1002', 'Producto2', 'Descripcion 2', 60, '2026-11-30', '2025-06-14', 15, 25,1),
('1003', 'Producto3', 'Descripcion 3', 70, '2026-10-31', '2025-06-14', 10, 20,0),
('1004', 'Producto4', 'Descripcion 4', 80, '2026-09-30', '2025-06-14', 12, 22,0),
('1005', 'Producto5', 'Descripcion 5', 90, '2026-08-31', '2025-06-14', 18, 28,1),
('1006', 'Producto6', 'Descripcion 6', 100, '2026-07-31', '2025-06-14', 25, 35,1),
('1007', 'Producto7', 'Descripcion 7', 110, '2026-06-30', '2025-06-14', 30, 40,1),
('1008', 'Producto8', 'Descripcion 8', 120, '2026-05-31', '2025-06-14', 22, 32,1),
('1009', 'Producto9', 'Descripcion 9', 130, '2026-04-30', '2025-06-14', 28, 38,1),
('1010', 'Producto10', 'Descripcion 10', 140, '2026-03-31', '2025-06-14', 35, 45,1);
