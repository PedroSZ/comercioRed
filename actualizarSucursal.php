...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center mt-4">Actualizar sucursal</h1>
    <p class="text-center">Edite los campos de desea actualizar.</p>
    </div>
    <?php include_once 'forms/form_act_sucursal.php' ?>
    </div>
