...
<html lang="en">
  ...
  <body class="form-page">
    ...
    <h1 class="text-center mt-4">Nueva Sucursal</h1>
    <p class="text-center">Por favor, complete el formulario a continuación para registrar un nuevo punto de venta.</p>
    <?php include_once 'forms/form_reg_sucursal.php' ?>
    </div>
